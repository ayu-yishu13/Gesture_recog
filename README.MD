...
Left-hand landmarks are mirrored to match right-hand geometry

A Random Forest classifier predicts the class

Confidence threshold + temporal smoothing determine final output

Low-confidence inputs are labeled as Unknown
